...
<body>
    ...
    function autogradeExam(student, exam_title) {
        var form = $(
            `<form style="display:none;" action="ReviewExam.php" method="post"><input type="text" name="student" value="${student}"><input type="text" name="exam_title" value="${exam_title}"></form>`
            );
        $("body").append(form);
        form.submit();
    }
