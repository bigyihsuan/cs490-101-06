...
<body>
    ...
    <table>
        <tr>
            <td style="width:50%;background:#ededed;padding-left:10px;padding-right:10px;padding-top:35px;"
                valign="top">
                <div id="filters">
                    <script>
            ...
            <td style="width:50%;padding-left:5%;padding-right:5%;padding-top:35px;background:#ededed;"
                valign="top">
                <p>Exam Questions</p>
                <form id="exam_questions_form" method="post">
                    <input type="submit"><br>
                    <input id="exam_title" type="text" placeholder="Exam Title">
                    <table id="exam_questions_table" align="center" border="1px"
